...
(function () {
    var oBox = document.getElementById('banBox');
...
(function () {
    var oBox = document.getElementById('banBox2');
    var oBoxInner = oBox.getElementsByTagName('div')[0];
    var aDiv = oBoxInner.getElementsByTagName('div');
    var aImg = oBoxInner.getElementsByTagName('img');
    var oUl = oBox.getElementsByTagName('ul')[0];
...
/*(function(){
    var oBox=document.getElementById('hide1');
    var oMark=document.getElementById('show1');
    oBox.onmouseover=function(e){
        e=e||window.event;
        var tar= e.target|| e.srcElement;
        if(tar.id==='mark'||tar.id==='box'){
...
(function(){
    ...
    var oBox=document.getElementById('hide1');
    var oMark=document.getElementById('show1');
    shi.onmouseenter=function(e){
        var target=this.children[1];
        if(target) {
            target.style.display="block"
        }

    };
    shi.onmouseleave=function(){
        var target=this.children[1];
        if(target) {
